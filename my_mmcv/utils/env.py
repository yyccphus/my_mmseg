...
def collect_env():
    ...
    if cuda_available:
        ...
        from my_mmcv.utils.parrots_wrapper import _get_cuda_home
    ...
    env_info['MMCV'] = my_mmcv.__version__

    try:
        from my_mmcv.ops import get_compiler_version, get_compiling_cuda_version
    except ModuleNotFoundError:
